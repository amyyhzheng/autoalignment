...
# FOLDER ='/Users/amyzheng/Desktop/coronalsectionplot/metrics'
...
# # '/Volumes/nedividata/Amy/Imaging/3562analysis/3562_60x_Cell1_A01_G003_0001_somaapical1_xyzCoordinates.csv'
# #'/Users/amyzheng/Desktop/coronalsectionplot/3562Trace/3562_10xOverview_A01_G003_0001_2_xyzCoordinates.csv'
# # BRANCHPOINTS_CSV = '/Users/amyzheng/Desktop/coronalsectionplot/branchpointsnew3562.csv'

# TRACE_CSV = '/Users/amyzheng/Desktop/coronalsectionplot/3562Trace/3562_10xOverview_A01_G003_0001_2_xyzCoordinates.csv' 
# BRANCHPOINTS_CSV = '/Users/amyzheng/Desktop/coronalsectionplot/3562Trace/branchpoints.csv'

# XCOL, YCOL, ZCOL = "extra_x", "extra_y", "extra_z"
# MAX_EDGE_LENGTH = 100000000000



# SOMA_XYZ = (773, 776, 158)
...
def add_virtual_bridge(G, kdtree_nodes, node_coords, a_xyz, b_xyz):
    ...
    Returns: (VIRTUAL_EDGES_SET, a_node, b_node, snap_dist_a, snap_dist_b)
    """
    ...
    w = float(np.linalg.norm(np.asarray(a_node) - np.asarray(b_node)))  # Euclidean jump length
