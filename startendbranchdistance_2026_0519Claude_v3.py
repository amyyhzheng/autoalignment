...
trace_file_path = input("Enter the full path to the trace file (SOM055_Image5_FullTrace_xyzCoordinates.csv): ").strip()
...
for branch_id in BRANCH_IDS:
    ...
    branch_marker_file = branch_dir / f"SOM055_Image5_branch{branch_id}.csv"
...
if len(results) > 0:
    ...
    output_file = puncta_scoring_dir / "branch_distances_summary.csv"
