...
images_root = Path(r'Z:\Joe\AnalysisCode_forSharing\ExampleData\FullyAnalyzed\Analyzed_Data\SNTTrace')
puncta_root = Path(r'Z:\Joe\AnalysisCode_forSharing\ExampleData\FullyAnalyzed\Analyzed_Data\AlignmentAndChecking\AfterCorrections')
