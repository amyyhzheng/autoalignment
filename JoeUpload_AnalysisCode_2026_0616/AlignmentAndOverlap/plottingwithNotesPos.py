...
def plot_markers_along_branch_from_napari_notes(
    ...
    pat = re.compile(
        rf".*Image(\d+)_branch{re.escape(branch_number)}_snapped_bouton_overlap.*\.csv$",
        re.IGNORECASE,
    )
    ...
    type_to_color = {
        ...
        "Ambiguous": "gray",
        "Shaft_SyntdNotScored": "orange",
        "Spine_SyntdNotScored": "orange",
        "Shaft_SynTd": "cyan",
        "Spine_SynTd": "navy",
        None: "black",
    }
...
plot_markers_along_branch_from_napari_notes(
    napari_dir=r'Z:\Joe\AnalysisCode_forSharing\ExampleData\FullyAnalyzed\Analysis_withAmyCode_cell1\AlignmentAndChecking\BeforeCorrections\AlignmentOverlap_BestThreshold\Analysis_withAmyCode_cell1_branch1',
    landmarks_csv_path=r'Z:\Joe\AnalysisCode_forSharing\ExampleData\FullyAnalyzed\Analysis_withAmyCode_cell1\AlignmentAndChecking\BeforeCorrections\AlignmentOverlap_BestThreshold\Analysis_withAmyCode_cell1_branch1\plots\shaft_landmarks.csv',
    branch_number=1,
    title="Markers along branch from napari Notes —  clusters",
)