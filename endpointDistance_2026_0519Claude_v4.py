...
BASE_DIR = Path(
    r"Z:\Joe\2p_data\SOM\ThirdRound\SOM055_DOB051322_TT\Analysis_withAmyCode_cell4"
)

TRACE_CSV = BASE_DIR / "SNTTrace/Full_Cell_SNT/SOM055_Image5_FullTrace_xyzCoordinates.csv"

TOPOLOGY_CSV = r'Z:\Joe\2p_data\SOM\ThirdRound\SOM055_DOB051322_TT\Analysis_withAmyCode_cell4\SNTTrace\Full_Cell_SNT\SOM055_Image5_SNT_BranchInfo.csv'
AFTER_MANUAL_EDITS_DIR = BASE_DIR / "AlignmentAndChecking/AfterManualEdits"

OUT_DIR = Path(r"Z:\Joe\2p_data\SOM\ThirdRound\SOM055_DOB051322_TT\Analysis_withAmyCode_cell4\SNTTrace\Full_Cell_SNT\Scaled_forCheckingDistances\codetest_2026_0519b")
...
def make_matches_for_branch(
    ...
    extra_points_csv = (
        ...
        / f"Image5_branch{branch_id}_snapped_bouton_overlap_with_empty.csv"
    )

    out_csv = OUT_DIR / f"branch{branch_id}_Image5_dendritic_distances.csv"
